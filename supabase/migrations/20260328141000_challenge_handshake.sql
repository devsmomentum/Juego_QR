-- ============================================================================
-- MIGRATION: Add challenge columns for HMAC handshake + update RPCs
--
-- The Edge Function generates an HMAC-SHA256 challenge on start-session,
-- stores it in the session row, and validates it on verify-session.
-- This prevents forged session completions even if session_id is known.
-- ============================================================================

-- 1) Add challenge columns
...
-- 2) Update start_minigame to accept and store challenge_hash
...
-- 3) Update verify_and_complete_minigame to accept and validate challenge
