-- Migration: Update user_activity_feed to include stripe invoice_url
-- This allows the UI to show a "View Invoice" button for successful recharges.
...
CREATE VIEW "public"."user_activity_feed" AS
 SELECT 
    ...
    COALESCE(co_fk.invoice_url, co_meta.invoice_url) AS invoice_url -- Added field
