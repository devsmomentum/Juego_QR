...
class _RequestsManagementScreenState extends State<RequestsManagementScreen> {
  ...
  Future<void> _loadData() async {
    ...
    // Ya no cargamos fetchAllPlayers() porque no gestionamos usuarios pendientes aquí
    await Future.wait([
      ...
      appBar: AppBar(
        title: Row(
          children: const [
            ...
            SizedBox(width: 10),
            Text("Solicitudes de Eventos"), // Título actualizado
          ],
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Solicita ingreso al evento: ',
              style: const TextStyle(color: Colors.white70),
            ),
            const SizedBox(height: 4),
            Text(
              request.eventTitle ?? "ID: ${request.eventId}",
              style: const TextStyle(
                color: AppTheme.secondaryPink,
                fontWeight: FontWeight.bold,
                fontSize: 15,
