...
class _ClueFinderScreenState extends State<ClueFinderScreen>
  ...
  Future<void> _startLocationUpdates() async {
    ...
    _positionStreamSubscription =
      ...
      if (_positionHistory.length > 5) {
        _positionHistory.removeAt(0); // Mantener solo los Ãºltimos 5 puntos
      }
        ...
        child: AlertDialog(
          ...
          title: Row(
            children: [
              ...
              Expanded(child: Text("UbicaciÃ³n Falsa Detectada", style: TextStyle(color: isDarkMode ? Colors.white : const Color(0xFF1A1A1D), fontSize: 18))),
            ],
          ),
          content: Text(
            "Para jugar limpio, debes desactivar las aplicaciones de ubicaciÃ³n falsa (Fake GPS).\n\nEl juego se detendrÃ¡ hasta que uses tu ubicaciÃ³n real.",
  ...
  void _handleScannedCode(String scannedCode) {
    ...
    if (isValid) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("QR Incorrecto. Ese no es el cÃ³digo de esta misiÃ³n, intenta de nuevo."),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Si sales ahora, interrumpirÃ¡s la bÃºsqueda del objetivo y tu progreso actual.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    // Overlay más suave para que la foto sea la protagonista
